...
namespace Marielinas.ASP.NET6._0.Repository
{
    public class AppDbContext : IdentityDbContext<StoreUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) { 
            ...
            //seed categories
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 1, CategoryName = "Fruit pies" ,Description="Fruit Fusion Pies Marilina's Special" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 2, CategoryName = "Cheese cakes", Description="Cheese Fusion With a Great Hand" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 3, CategoryName = "Seasonal pies" , Description="Seasonal Special Pies" });
