...
namespace Marielinas.ASP.NET6._0.Migrations
{
    ...
    [Migration("20220525080555_Identity Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "Fruit Fusion Pies Marilina's Special"
                        },
                        new
                        {
                            CategoryId = 2,
                            CategoryName = "Cheese cakes",
                            Description = "Cheese Fusion With a Great Hand"
                        },
                        new
                        {
                            CategoryId = 3,
                            CategoryName = "Seasonal pies",
                            Description = "Seasonal Special Pies"
                        });
                });

            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.OrderDetail", b =>
                {
                    b.HasOne("Marielinas.ASP.NET6._0.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Marielinas.ASP.NET6._0.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Marielinas.ASP.NET6._0.Models.Pie", b =>
                {
                    b.HasOne("Marielinas.ASP.NET6._0.Models.Category", "Category")
                        .WithMany("Pies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Marielinas.ASP.NET6._0.Models.StoreUser", null)
                        .WithMany()
